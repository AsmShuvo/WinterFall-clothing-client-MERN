...
const Footer = () => {
    return (
        <div>
            <footer className="footer bg-gray-900 text-white items-center p-4">
                ...
                <nav className="flex gap-4 md:place-self-center md:justify-self-end">
                    ...
                    <a href="https://www.youtube.com" target="_blank" rel="noopener noreferrer" className="text-red-500 hover:text-red-400">
                        <FaYoutube size={24} />
                    </a>
                </nav>
            </footer>
